...
<div class="container">
    <span><?= Yii::t('app', 'Show') ?>: <a class="nav-item dropdown-toggle bg-white text-dark" href="#" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul class="dropdown-menu bg-white text-dark border" aria-labelledby="navbarDropdown1">
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/catitem', 'item' => $_GET['item'], 'sort' => 'asc']); ?>"><?= Yii::t('app', 'Low-to-High') ?></a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/catitem', 'item' => $_GET['item'], 'sort' => 'desc']); ?>"><?= Yii::t('app', 'High-to-Low') ?></a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/catitem', 'item' => $_GET['item'], 'sort' => 'orders']); ?>"><?= Yii::t('app', 'By orders') ?></a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/catitem', 'item' => $_GET['item'], 'sort' => 'popularity']); ?>"><?= Yii::t('app', 'By popularity') ?></a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/catitem', 'item' => $_GET['item'], 'sort' => 'novelty']); ?>"><?= Yii::t('app', 'By novelty') ?></a></li>
        </ul>
    </span>
</div>
