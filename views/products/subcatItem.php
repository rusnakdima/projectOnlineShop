...
<div class="container">
    <span>Show: <a class="nav-item dropdown-toggle bg-white text-dark" href="#" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul class="dropdown-menu bg-white text-dark border" aria-labelledby="navbarDropdown1">
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/subcatitem', 'item' => $_GET['item'], 'sort'=>'asc']); ?>">Low-to-High</a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/subcatitem', 'item' => $_GET['item'], 'sort'=>'desc']); ?>">High-to-Low</a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/subcatitem', 'item' => $_GET['item'], 'sort'=>'orders']); ?>">By orders</a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/subcatitem', 'item' => $_GET['item'], 'sort'=>'popularity']); ?>">By popularity</a></li>
            <li><a class="dropdown-item text-dark" href="<?= Url::to(['products/subcatitem', 'item' => $_GET['item'], 'sort'=>'novelty']); ?>">By novelty</a></li>
        </ul>
    </span>
</div>
