<?php
    ...
    $this->title = Yii::t('app', 'Editing categories');
?>
...
<div class="container bg-white text-dark border rounded-2 px-5 py-5">
    ...
    <div class="row row-cols-auto">
        <h3 class="col-6 mb-3 fw-normal"><?= Yii::t('app', 'Categories') ?></h3>
        <?php $form = ActiveForm::begin(); ?>
            ...
            ])->textInput()->label(Yii::t('app', 'Search categories')) ?>
        <?php ActiveForm::end(); ?>
    </div>
    <br>
...
<div class="container bg-white text-dark border rounded-2 px-5 py-5">
    <details>
        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            ])->textInput()->label(Yii::t('app', 'Category')) ?>
